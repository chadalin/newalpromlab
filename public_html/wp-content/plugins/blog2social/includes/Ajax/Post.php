                        ...
                        if(empty($postIds)) {
                            ...
                            if (isset($_POST['b2s-re-post-share-option'])) {
                                ...
                                foreach ($postIds as $k => $postId) {
                                    ...
                                    $keywords = get_the_tags((int) $postId);
                                    if (($keywords == false || empty($keywords)) && taxonomy_exists(get_post_type((int) $postId) . '_tag')) {
                                        $keywords = get_the_terms((int) $postId, get_post_type((int) $postId) . '_tag');
                                    }
